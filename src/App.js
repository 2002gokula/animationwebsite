            ...
            <div className="TopNav-wrapper">
              <div className="TopNav-logo">
                <svg viewBox="0 0 31 61" xmlns="http://www.w3.org/2000/svg">
                  <path
                    className="logo-icon stop-loader"
                    d="M31,0C14.4,0,1,13.4,1,30s13.4,30,30,30V0z"
                  />
                </svg>
              </div>
              <div className="TopNavMenu show" style={{}}>
                <div className="TopNavMenu-hamburger">
                  <div id="line-1" />
                  <div id="line-2" />
                </div>
                <div className="TopNavMenu-popup">
                  <div className="TopNavMenu-popup-content-wrapper">
                    <div className="TopNavMenu-logo">
                      <svg
                        version="1.1"
                        id="Layer_1"
                ...
                >
                  ...
                  >
                    <div className="VideoHead-header-desktop">
                      <span data-index={1}>
                        Clay is a UI/UX design and branding
                      </span>
                      <span data-index={2}>agency in San Francisco.</span>
                    </div>
                  ...
                  <div
                    ...
                    style={{ width: 1350, marginLeft: 248 }}
                  >
                  ...
                  >
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            ...
                            with an in‑depth discovery phase to immerse
                            ourselves in your business. Our UX designers
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            ...
                            that spans across all mediums and touchpoints. We're
                            a branding agency offering a complete solution from
                            naming and logo design to communications and style
                            guides.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            ...
                            applications, or multi‑platform digital experiences.
                            As a UX design agency, we create products and
                            services that provide outstanding usability while
                            fully embracing your brand's personality.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="IndexDescription-item">
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            Our full‑stack design and development agency based
                            in San Francisco provides front‑end and back‑end
                            development services working closely with our
                            designers. As a UX UI and app development company,
                            we build native mobile apps for iOS and Android, web
                            applications, apps for wearables, and B2B/enterprise
                            software.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="IndexDescription-item">
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            We're a web design agency creating next‑level
                            ...
                            home on any device. Product landing pages, marketing
                            sites, or UX UI for company intranet portals – we do
                            it all.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="IndexDescription-item-wrapper">
                        <div className="IndexDescription-item-text">
                          <p>
                            ...
                            software deserves the user‑friendliness and
                            aesthetics of best‑in‑class consumer apps. We're a
                            digital agency that transforms legacy enterprise
                            platforms into delightful, consumer‑grade
                            experiences and design new B2B products that people
                            love using.
                          </p>
                        </div>
                      </div>
                            ...
                            <div className="ProjectsItem-imageWrapper">
                              ...
                              >
                                ...
                                <img
                                  ...
                                  alt=""
                                />
                                <div className="ProjectsItem-imageClipper-left" />
                        ...
                        <div className="IndexAbout-text-wrapper">
                          <div>
                            ...
                            >
                              ...
                              <a
                                target="_blank"
                                href="https://ui-ux-agency.medium.com/top-user-experience-ui-ux-design-agencies-37f6423bde26"
                              >
                                UX design agency
                              </a>
                              , we work closely with our clients to define,
                              design and develop transformative user experiences
                ...
                >
                  <div className="AboutGallery-content">
                    <div
                      ...
                      style={{ transform: "translate3d(3899px, 0px, 0px)" }}
                    >
                    ...
                    <ul>
                        ...
                        <div className="IndexNews-link">
                          ...
                          >
                            <span className="IndexNews-link-inner">
                              UX Design Deliverables from a Silicon Valley
                              Agency
                            </span>
                            <div
                      ...
                      <li data-scroll="" data-scroll-offset={50}>
                        ...
                        <div className="IndexNews-link">
                          ...
                          >
                            <span className="IndexNews-link-inner">
                              Our Design Directors Judge Several International
                              Design Awards
                            </span>
                            <div
                              className="IndexNews-imageContainer"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              User experience is more than a capability for us.
                              It’s at the core of everything we do here at Clay.
                              We started in San Francisco as a UI/UX design
                              agency and website design company focused on
                              mobile apps but quickly expanded our offering to
                              web applications, enterprise software, and
                              emerging technologies such as AR/VR and wearables.
                              The UX UI and web design projects we take on range
                              from building a new product to redesigning an
                              existing mobile app, website, or enterprise
                              software. We do everything you might need to bring
                              a successful digital product to life: user
                              research, product strategy, user interface, and
                              user experience design, usability testing,
                              prototyping, web design and development.
                              <br />
                              <br />
                              It’s no surprise that our web design clients are
                              often the same companies who hired us for UI/UX
                              design projects, because who can explain the
                              product better than the people who designed it?
                              We’re a web design agency that believes a great
                              website should efficiently convert visitors to
                              customers while providing a delightful web
                              experience that’s true to the brand. Good UX UI
                              design of a digital product or website leads to
                              higher conversion rates. That’s why unlike other
                              web design agencies, we have UX designers
                              collaborate with web designers on all website
                              design projects.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        >
                          What separates Clay from other top UX and web design
                          agencies?
                          <em />
                        </div>
                        <div
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              We get this question a lot. There are many
                              competent UX agencies in San Francisco alone and
                              even more globally. It’s hard to be different when
                              the standard is so high. <br />
                              <br />
                              So how do we stand out? First and foremost, it’s
                              the quality of our UX UI design work and the craft
                              it takes to make it. The digital products and user
                              interfaces we create are easy to use, look great,
                              and represent your brand in the best way possible.
                              Then, it’s the people who make your project a
                              reality. We always assign a multidisciplinary team
                              of senior UX UI designers, developers, and other
                              specialists led by one of our design directors and
                              overseen by a co‑founder.
                              <br />
                              <br />
                              Finally, unlike most traditional digital design
                              firms and user experience designers, we combine
                              creative and product design capabilities under one
                              roof and on the same project. Imagine a branding
                              firm meets a UI UX design agency — that’s us.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              Yes, we can. We’re world‑famous for creating
                              marketing websites that meet our clients’ goals by
                              merging brand storytelling and award‑winning web
                              design with the latest and greatest web
                              technologies. Our sites convert well, and people
                              share them like crazy, which helps us get new
                              clients who are already huge fans of our work.{" "}
                              <br />
                              <br />
                              For example, the new{" "}
                              <a
                                target="_blank"
                                rel="nofollow"
                                href="http://zenefits.com"
                              >
                                Zenefits.com
                              </a>{" "}
                              website we recently redesigned has seen a whopping
                              147% spike in conversion. Yes, that’s 2.6 times
                              more. With each new project, we challenge
                              ourselves to try something new, like improving our
                              processes to optimize costs or simply work faster
                              without losing quality.
                              <br />
                              <br />
                              Our web design company is ideally equipped to
                              deliver websites for tech startups unlike other
                              web design firms who mainly work on web design for
                      ...
                      >
                        ...
                        >
                          Do you do branding or should I hire a separate
                          branding agency?
                          <em />
                        </div>
                        <div
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              Yes, we do. First and foremost, we're a user
                              experience agency, branding is an integral part of
                              any UX UI design project. We position ourselves as
                              a new kind of branding agency focused on tech
                              companies, digital products, and
                              direct‑to‑consumer brands. Not so many UX design
                              agencies can create a visual identity for a coffee
                              shop like we did for Joe &amp; The Juice. Our
                              branding capabilities include research, brand and
                              digital strategy, logo design, visual identity,
                              graphic design, motion design, and style guide
                              development, and web design, among other things.
                              <br />
                              <br />
                              However, our clients often provide us with either
                              a brand strategy or even a complete visual
                              identity package. In these cases, we use the
                              current brand foundation as a starting point, not
                              just carefully applying it to whatever we’re
                              designing but making sure we extend and enrich the
                              brand while staying true to its roots.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              Our pricing is directly related to the project
                              scope, timeline, deliverables, and team
                              composition. When the scope isn’t set in stone, or
                              the project is very dynamic, we prefer engaging on
                              a time and materials basis where you pay us for
                              the time spent. However, most of our UX UI
                              engagements are fixed‑price contracts. In this
                              case, we’ll give you a detailed proposal after
                              learning as much as possible about your project.
                              All estimates are calculated based on the hourly
                              rates and the number of hours we think the job
                              will take.
                              <br />
                              <br />
                              As an illustration, a sample project with a UX
                              design agency may take ten weeks and cost
                              $150k‑$200k. For time and materials engagements,
                              we would create a custom rate card for you based
                              on the team composition. Our rates span from
                              $100/hour for junior designers to $350/hour for
                              our design directors. We also offer special rates
                              for qualified startups. Please{" "}
                              <a href="mailto:hey@clay.global">email us</a> to
                              get a quote.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        >
                          Do you work with startups? If so, how can my
                          early‑stage company afford you?
                          <em />
                        </div>
                        <div
                          className="IndexFaq-item-wrapper"
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              As a San Francisco‑based UX design agency, we
                              partner with startups big and small all the time.
                              What can be better than helping founders bring to
                              life ideas the world has never seen before? We
                              enjoy a fast‑moving environment that challenges
                              our skills and process. The ultimate achievement
                              for us is seeing our startup clients grow and take
                              over the world.
                              <br />
                              <br />
                              We worked with Uber when they were a team of ten
                              and helped design such iconic products as Path and
                              SendGrid. We have special discounted rates for
                              startups we believe in.{" "}
                              <a href="mailto:anton@clay.global">
                                Email our CEO Anton
                              </a>{" "}
                              to learn more.
                            </p>
                      ...
                      >
                        ...
                        >
                          Can you help us redesign our legacy enterprise/B2B
                          software?
                          <em />
                        </div>
                        <div
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              Yes, we’re up to the challenge. We’re one of the
                              few user experience firms specializing in
                              enterprise UX design and digital transformation of
                              legacy business software. We’ve perfected our
                              process over the years, modernizing digital
                              platforms for Fortune 100 companies such as ADP,
                              Amazon, and Facebook. We start each new enterprise
                              UX project with a deep‑dive discovery and research
                              to fully immerse ourselves in the industry and
                              project specifics.
                              <br />
                              <br />
                              We're a full-service digital agency and our
                              services span from user research and information
                              architecture, UX UI design, prototyping, and user
                              testing to full‑stack development and design
                              systems. Our UI UX design firm acts as an
                              independent entity that moves fast, avoiding the
                              bureaucracy of a large organization, often working
                              hand‑in‑hand with innovation labs and in‑house UX
                              teams.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              Our UI/UX design process is based on the design
                              thinking methodology, which allows us to be
                              flexible, adapting to almost any project type and
                              collaboration model. While each UX UI design
                              engagement is unique, we always go through the
                              following key phases:
                              <br />
                              <br />
                              <span>Discovery &amp; Research</span>
                              <br />
                              We usually start by consolidating all available
                              project documentation and scheduling UX workshops
                              with your team. During those sessions, we
                              interview key stakeholders, collaborate on
                              requirements, as well as ideate, and plan the next
                              steps. When possible, our UX designers talk to
                              your current or potential customers to understand
                              their needs and pain points. In some cases, we may
                              need to audit your existing product to identify
                              opportunities for improvements to user experience.
                              We will also review competitor products, gather
                              visual design references, and document best
                              practices.
                              <br />
                              <br />
                              <span>Digital Strategy &amp; Concepts</span>
                              <br />
                              Based on the discovery &amp; research results, we
                              synthesize a digital strategy and define a UX
                              approach to drive our design process. Since we're
                              a UI/UX design agency, we will explore different
                              concepts to establish such core elements as
                              information architecture, key screen layouts, and
                              UI design direction. We then validate the
                              resulting concept with users and stakeholders.
                              Once the feedback is in, we make necessary updates
                              to proceed with designing the rest of the product.
                              <br />
                              <br />
                              <span>UI/UX Design</span>
                              <br />
                              After the UI design concept has been approved, we
                              start designing the UI and UX, continuously
                              conducting user tests, and iterating along the
                              way. The UX UI design main activities include user
                              flow mapping, wireframing, user interface design,
                              interaction design, and prototyping. We hand off
                              design assets to developers using tools like
                              Zeplin and provide a comprehensive style guide
                              that includes a UI component library, UX
                              guidelines, and complete user flows.
                              <br />
                              <br />
                              Learn more about our UI design studio process and
                              deliverables{" "}
                              <a href="/news/ux-design-agency-deliverables/">
                                here
                              </a>
                              .
                            </p>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p itemProp="text">
                              If you're looking for a UI/UX design agency,
                              please send us an{" "}
                              <a href="mailto:hey@clay.global">email</a> first
                              with a quick summary of your project or an
                              RFI/RFP. We usually reply within 24 hours to
                              schedule an introductory call and ask any
                              immediate questions. During our first call, we
                              will ask a lot of questions about the project
                              goals, audience, budget, timeline, and other
                              essential details. We can sign an NDA if
                              necessary, but we always treat all client
                              conversations as confidential. We recommend
                              contacting several user experience design
                              companies to compare their prices and UX UI
                              approach.
                              <br />
                              <br />
                              While many UI &amp; UX design agencies only work
                              by the hour, we try to estimate the project cost
                              as precisely as possible before we start. After
                              the call, we may request various documentation
                              such as a design brief, project requirements, past
                              designs, etc. If we’re redesigning an existing
                              digital product, we’ll want to schedule a demo or
                              try it ourselves.
                              <br />
                              <br />
                              We will email you a proposal and can schedule a
                              video call to walk you through it. The UX design
                              agency proposal will include a detailed
                              description of our UX UI approach, project phases,
                              activities, and deliverables, design team
                              composition, and relevant case studies.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            >
              <div className="Footer-links">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://twitter.com/clayglobal"
                      target="_blank"
                      rel="nofollow"
                    >
                      Twitter
              ...
              <div className="Footer-address">
                <span>300 Broadway, Suite 23</span>
